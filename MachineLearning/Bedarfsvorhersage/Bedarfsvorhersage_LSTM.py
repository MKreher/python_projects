...
# load the dataset
df = pd.read_csv('./data/Bedarfsvorhersage.csv', sep=',', parse_dates=True, index_col=0)
print(df.head(10))
data = df.values
...
mdl.fit(X_train, y_train, epochs=10000, batch_size=10, verbose=2, callbacks=[tbCallBack])
